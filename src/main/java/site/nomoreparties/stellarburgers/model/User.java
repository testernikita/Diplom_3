...
public class User {
    ...
    public static User getRandom() {
        final String email = RandomStringUtils.randomAlphabetic(5) + DOMAIN_POSTFIX;
    ...
    public static User createUserWithoutName() {
        return new User().setPassword(RandomStringUtils.randomAlphabetic(10)).setEmail(RandomStringUtils.randomAlphabetic(5) + DOMAIN_POSTFIX);
    }
